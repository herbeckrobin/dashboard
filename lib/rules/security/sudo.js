...
# Paketmanager
deploy ALL=(ALL) NOPASSWD: /usr/bin/apt-get update, /usr/bin/apt-get install *, /usr/bin/apt-get upgrade *
...
deploy ALL=(ALL) NOPASSWD: /usr/bin/chown * /home/deploy/*, /usr/bin/chmod * /home/deploy/*, /usr/bin/chown * /var/*, /usr/bin/chmod * /var/*, /usr/bin/mkdir -p /opt/*, /usr/bin/mv /tmp/* /opt/*, /usr/bin/mv /tmp/* /etc/*
