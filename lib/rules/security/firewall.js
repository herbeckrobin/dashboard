...

  {
    ...
    async audit({ runCmd }) {
      ...
      return {
        ...
        actual: exposed.length ? `Exponiert auf 0.0.0.0: ${exposed.join(', ')}` : 'Alle intern (127.0.0.1)',
        expected: 'Interne Services nur auf 127.0.0.1',
      }
    },
    // Kein enforce — Services muessen einzeln umkonfiguriert werden
    enforce: null,
  },
]
