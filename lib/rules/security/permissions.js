...
export default [
...

  {
    ...
    async enforce({ runCmd }) {
      await runCmd('chmod 700 /home/deploy/backups')
      // Alle Backup-Dateien ebenfalls einschraenken
      await runCmd('chmod -R o-rwx /home/deploy/backups/ 2>/dev/null || true')
      return { changed: true }
    },
  },

  {
    ...
    async audit({ runCmd }) {
      ...
      const worldReadable = await runCmd('find /home/deploy/backups -type f -perm -o+r 2>/dev/null | head -5')
