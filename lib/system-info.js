...
export async function getSystemInfo() {
  // PHP-FPM-Version dynamisch erkennen (8.2 auf Debian, 8.3 auf Ubuntu 24.04+)
  const phpVersionOut = await runQuick("dpkg -l 'php*-fpm' 2>/dev/null | grep ^ii | head -1 | awk '{print $2}' | sed 's/-fpm//'")
