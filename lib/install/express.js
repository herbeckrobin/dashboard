...
`
  ...
  steps.push({
    ...
    cmd: `cd ${projectPath} && git init -b main && git add -A && git ${getGitConf()} commit -m "Express Starter" && git remote add origin ${gitUrl} && git ${getGitCredentialHelper()} push -u origin main --force`
  })
