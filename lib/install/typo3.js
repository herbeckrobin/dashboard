...
export function getTypo3Steps(project) {
  ...
  steps.push({
    name: 'Git Push (TYPO3)',
    cmd: `cd ${projectPath} && git init -b main && git add -A && git ${getGitConf()} commit -m "TYPO3 Installation" && git remote add origin ${gitUrl} && git ${getGitCredentialHelper()} push -u origin main --force`
  })
